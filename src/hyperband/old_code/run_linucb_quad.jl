...
reward,alpha_config,trace_params = run_linucb_quad(T,data_area,pq_bounds,vt_bounds,initial_config,optimizer,lambda)
bson("data/hyperband/linucb_quad_$casename"*"_$run_num.jl", Dict("alpha_config" => alpha_config, "reward" => reward, "trace" => trace_params))
